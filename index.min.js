...
export class Door extends Phaser.GameObjects.Zone{constructor(i,e,s,t,n,o,h){super(i,e,s,t,n),this.setOrigin(0,1),i.add.existing(this),i.physics.world.enable(this,1),this.destination=o,this.link=h,i.physics.add.collider(i.player,this,(()=>this.enterDoor(i)))}enterDoor(i){!i.player.body.touching.none&&i.player.body.wasTouching.none&&(this.link?window.location.href="./home.html#"+this.destination:i.scene.switch(this.destination))}}
